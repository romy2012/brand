...
<body>
		...
		<div id="close" class="dynamic"
			onMouseOver="this.style.backgroundColor = colors['light'][getj(current)];document.getElementById(current).onmouseover();"
			onMouseOut="this.style.backgroundColor = '';if (!busy) {unselect();}"
			onMouseUp="if (close_click) {document.images['closebox'].src = 'images/closebox.gif';close_click=false;closeCell(current, '') }"
			onMouseDown="close_click=true;document.images['closebox'].src = 'images/closebox_pressed.gif'"><img
				src="images/closebox.gif" name="closebox" /></div>
		...
		<div id="masktop" class="dynamic" style="background-color:#FFF">
			<div id="masktopinner" class="dynamic" style="background:url('images/bg.gif')"></div>
		</div>
		<div id="maskbottom" class="dynamic" style="background-color:#FFF">
			<div id="maskbottominner" class="dynamic" style="background:url('images/bg.gif')"></div>
		</div>
		<div id="scrolldiv"
			onMouseOver="this.style.backgroundColor = colors['light'][getj(current)];document.getElementById(current).onmouseover();"
        ...
        <script type="text/javascript">
			...
			?>;
			titles = <?= $title_array ?>;
			type_array = [<? echo "'" . str_replace("'", "\\'", $type_array[0]) . "'";
			for ($i = 1; $i < $num_types; $i++)
				echo ", '" . str_replace("'", "\\'", $type_array[$i]) . "'"; ?>];
			num_days = <?= $day_count ?>;
			num_types = <?= $num_types ?>;
