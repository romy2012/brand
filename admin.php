                        ...
                        <table cellspacing="10" cellpadding="0" border="0" width="80%" style="padding-top:20px">
                            <tr>
                                <td width="55%" valign="top">
                                    <table cellspacing="0" cellpadding="5" border="0" width="100%">
                                        ...
                                        <tr>
                                            <td class="normal">
                                                企业全称：<br>
                                                <input type="text" name="title" class="normal" size="48" <?php if ($id)
                                                    echo ' value="' . htmlspecialchars($title, ENT_QUOTES, 'UTF-8') . '"'; ?>>
                                            </td>
                                        </tr>
                                    </table>
                                    <table cellspacing="0" cellpadding="5" border="0">
                                        <tr>
                                            ...
                                            <td class="normal">
                                                登记日期：<br>
                                                <input type="text" name="date" class="normal" size="12"
                                                    value="<?php if ($id)
                                            ...
                                            <td class="normal">
                                                登记时间：<br>
                                                <input type="text" name="time" class="normal" size="12"
                                                    value="<?php if ($id)
                                        ...
                                        <tr>
                                            <td class="normal" colspan="3">
                                                投放代码：<br>
                                                <textarea name="content" class="normal" cols="50"
                                                    rows="8"><?php if ($id)
                                                        echo htmlspecialchars($content, ENT_QUOTES, 'UTF-8'); ?></textarea>
                                            </td>
                                        </tr>
                                    </table>
                                    <table cellspacing="0" cellpadding="5" border="0">
                                        <tr>
                                            <td class="normal">
                                                授权登记：<br>
                                                <input type="text" name="login_disabled" class="normal" size="20" <?php if ($id)
                                                    echo " value=\"" . htmlspecialchars($login, ENT_QUOTES, 'UTF-8') . "\" disabled"; ?>>
                                            </td>
                                            <td class="normal">
                                                授权密码：<br>
                                ...
                                <td valign="top" class="normal" width="40%">
                                    ...
                                    <em><a
                                            href="<?php echo htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES, 'UTF-8'); ?>">新增</a></em><br>
                                    <em>修改：</em>
                                    <ol>
                                        <?php
